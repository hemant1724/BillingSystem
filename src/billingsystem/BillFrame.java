...
public class BillFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(972, 593));
        setName("BillFrame1"); // NOI18N
        setResizable(false);
        ...
        rate.setToolTipText("Please Enter the Rate.");
        ...
        qtyspinner.setDebugGraphicsOptions(javax.swing.DebugGraphics.BUFFERED_OPTION);
    ...
    private void mobileFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_mobileFocusLost
        /* String mno = mobile.getText();
         ...
         Matcher matcher = pattern.matcher(mno);
         if (!matcher.matches()) {
         JOptionPane.showMessageDialog(this, "Please Enter Coorect Mobile No. .", "Falied.", JOptionPane.ERROR_MESSAGE);
